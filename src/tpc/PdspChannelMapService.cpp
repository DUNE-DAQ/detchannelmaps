...
PdspChannelMapService::PdspChannelMapService(std::string rcename, std::string felixname)
{
  ...
  while (std::getline(inFile, line)) {
    unsigned int crateNo, slotNo, fiberNo, FEMBChannel, StreamChannel, slotID, fiberID, chipNo, chipChannel, asicNo,
      asicChannel, planeType, offlineChannel;
    std::stringstream linestream(line);
    linestream >> crateNo >> slotNo >> fiberNo >> FEMBChannel >> StreamChannel >> slotID >> fiberID >> chipNo >>
      chipChannel >> asicNo >> asicChannel >> planeType >> offlineChannel;
...
unsigned int
PdspChannelMapService::GetOfflineNumberFromDetectorElements(unsigned int crate,
                                                            unsigned int slot,
                                                            unsigned int fiber,
...
// does not depend on FELIX or RCE -- offline channels should always map to the same APA/crate regardless of RCE or
// FELIX

unsigned int
PdspChannelMapService::APAFromOfflineChannel(unsigned int offlineChannel) const
{
...
unsigned int
PdspChannelMapService::InstalledAPAFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::WIBFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::FEMBFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::FEMBChannelFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::StreamChannelFromOfflineChannel(unsigned int offlineChannel, FelixOrRCE frswitch) const
{
  check_offline_channel(offlineChannel);
  if (frswitch == kRCE) {
...
unsigned int
PdspChannelMapService::SlotIdFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::FiberIdFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::ChipFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::AsicFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
  return fvChipMap[offlineChannel];
}
...
unsigned int
PdspChannelMapService::ChipChannelFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::AsicChannelFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
  return fvChipChannelMap[offlineChannel];
}
...
unsigned int
PdspChannelMapService::AsicLinkFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
  return fvASICMap[offlineChannel];
}
...
unsigned int
PdspChannelMapService::PlaneFromOfflineChannel(unsigned int offlineChannel) const
{
  check_offline_channel(offlineChannel);
...
size_t
PdspChannelMapService::count_bits(size_t i)
{
  size_t result = 0;
...
unsigned int
PdspChannelMapService::SSPOfflineChannelFromOnlineChannel(unsigned int onlineChannel)
{
...
unsigned int
PdspChannelMapService::SSPOnlineChannelFromOfflineChannel(unsigned int offlineChannel) const
{
...
unsigned int
PdspChannelMapService::SSPAPAFromOfflineChannel(unsigned int offlineChannel) const
{
  SSP_check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::SSPWithinAPAFromOfflineChannel(unsigned int offlineChannel) const
{
  SSP_check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::SSPGlobalFromOfflineChannel(unsigned int offlineChannel) const
{
  SSP_check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::SSPChanWithinSSPFromOfflineChannel(unsigned int offlineChannel) const
{
  SSP_check_offline_channel(offlineChannel);
...
unsigned int
PdspChannelMapService::OpDetNoFromOfflineChannel(unsigned int offlineChannel) const
{
  SSP_check_offline_channel(offlineChannel);
