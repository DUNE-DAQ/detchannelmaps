...
public:
  ...
  PD2HDChannelMapSPPluginBase(const PD2HDChannelMapSPPluginBase&) =
    delete; ///< PD2HDChannelMapSPPluginBase is not copy-constructible
  PD2HDChannelMapSPPluginBase& operator=(const PD2HDChannelMapSPPluginBase&) =
    delete; ///< PD2HDChannelMapSPPluginBase is not copy-assignable
  PD2HDChannelMapSPPluginBase(PD2HDChannelMapSPPluginBase&&) =
    delete; ///< PD2HDChannelMapSPPluginBase is not move-constructible
  PD2HDChannelMapSPPluginBase& operator=(PD2HDChannelMapSPPluginBase&&) =
    delete; ///< PD2HDChannelMapSPPluginBase is not move-assignable
  ...
  std::optional<TPCChannelMap::TPCChannelInfo> get_channel_info_from_offline_channel(uint offchannel) final
  {
    ...
    return TPCChannelMap::TPCChannelInfo{ m_det_id,  ci.crate, slot_id,
                                          stream_id, chan_id,  m_elem_name_id_converter(ci.APAName) };
  }
};
