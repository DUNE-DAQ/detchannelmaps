...
register_hw_map_service(py::module& m)
{
  ...
  py_hwmapservice.def("get_hardware_map", &HardwareMapService::get_hardware_map)
    ...
    .def("get_serialized_hardware_map", &HardwareMapService::get_serialized_hardware_map)
    .def("deserialize_hardware_map", &HardwareMapService::deserialize_hardware_map);
}
