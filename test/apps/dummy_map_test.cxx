...
main()
{
  ...
  std::shared_ptr<TPCChannelMap> dummy_map = make_tpc_map("DummyChannelMap");
  ...
  std::shared_ptr<TPCChannelMap> hdcb_map = make_tpc_map("HDColdboxChannelMap");

  oc = hdcb_map->get_offline_channel_from_det_crate_slot_stream_chan(10, 1, 1, 1, 127);
