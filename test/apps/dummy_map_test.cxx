...
main()
{
  ...
  elem_id = dummy_map->get_element_id_from_offline_channel(oc);
  elem_name = dummy_map->get_element_name_from_offline_channel(oc);
  ...
  std::shared_ptr<TPCChannelMap> pd2hd_map = make_tpc_map("PD2HDTPCChannelMap");
  ...
  elem_id = hdcb_map->get_element_id_from_offline_channel(oc);
  elem_name = hdcb_map->get_element_name_from_offline_channel(oc);
  ...
  plane = pdvd2_map->get_plane_from_offline_channel(oc);
  elem_id = pdvd2_map->get_element_id_from_offline_channel(oc);
  elem_name = pdvd2_map->get_element_name_from_offline_channel(oc);
