...
public:
  ...
  HDColdboxTPCChannelMap& operator=(const HDColdboxTPCChannelMap&) =
    delete;                                                  ///< HDColdboxTPCChannelMap is not copy-assignable
  HDColdboxTPCChannelMap(HDColdboxTPCChannelMap&&) = delete; ///< HDColdboxTPCChannelMap is not move-constructible
  HDColdboxTPCChannelMap& operator=(HDColdboxTPCChannelMap&&) =
    delete; ///< HDColdboxTPCChannelMap is not move-assignable
};
