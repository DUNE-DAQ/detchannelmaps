...
public:
  ...
  std::optional<PDSChannelInfo> get_det_crate_slot_fiber_chan_from_offline_channel(uint offchannel) final
  {
  ...
  uint get_element_from_offline_channel(uint offchannel) final { return offchannel / 100; }
